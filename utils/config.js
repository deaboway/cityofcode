...
//配置域名,域名只修改此处。
//如果wordpress没有安装在网站根目录请加上目录路径,例如："www.deaboway.com/blog"
var DOMAIN = "www.deaboway.com";
var WEBSITENAME="代码之城"; //网站名称
var PAGECOUNT='10'; //每页文章数目
var ZANIMAGEURL = 'https://www.deaboway.com/wp-content/uploads/2020/08/zsm400.jpg';//微信鼓励的图片链接，用于个人小程序的赞赏
...
var INDEXNAV = [
  { id: '1', name: '排行', image: '../../images/uploads/rankings.jpg', url: '../hot/hot', redirecttype: 'apppage', appid: '', extraData: '' },
  { id: '2', name: '搜索', image: '../../images/uploads/search.jpg', url: '../search/search', redirecttype: 'apppage', appid: '', extraData: '' },
  { id: '3', name: '全栈', image: '../../images/uploads/miniprogram.png', url: '../list/list?categoryID=14', redirecttype: 'apppage', appid: '', extraData: '' },
